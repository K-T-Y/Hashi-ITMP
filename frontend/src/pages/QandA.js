...
console.log(answerModel.Answers[0].Question._id,"Sub")
const model={
  Content :typedAnswer,
  Question :answerModel.Answers[0].Question._id,
  User:"Kavindu",
  createdAt :Date.now()
}
  ...
  const arrange = () => {
    ...
    questions.map((item) => {
      //get answers for each question
        ...
        dat.push({ Question: item.Content, Answers: answerSet });
    ...
    <div className="App">
      ...
      <div className="paragraph">
        <Row>
                    ...
                    <div>
                      <div className="card col-md-10">
                        <div className="card-body">
                          ...
                          <button style={{marginLeft:"200px"}} className="btn btn-primary col-md-4" onClick={()=>{submitanswer(item)}}> Submit</button>
                          <br></br>
                        </div>
                      </div>
                      <br></br>
          ...
          <img alt="" width="60%" src={waste} style={{ marginLeft: "250px" }} />
        </Row>
      </div>
